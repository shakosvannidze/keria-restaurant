...
const translations = {
  ...
  ru: {
    ...
    menuImagePrefix: 'Меню ресторана «Керия»',
    pageWord: 'страница',
    pageLabels: [
      'Холодные закуски', 'Холодные закуски', 'Салаты', 'Хинкали',
      'Выпечка', 'Выпечка', 'Горячие блюда', 'Горячие блюда',
      'Горячие блюда', 'Рыбные блюда', 'Мясные блюда',
      'Гарниры и десерт', 'Соусы', 'Десерты',
